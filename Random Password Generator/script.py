...
strength = Frame(root, width = 300, height = 450, bd=8, relief="raise", padx=100, pady=20)
...
#Adding widgets
greeting = Label(top, text="Random Password Generator", width=40, height=2, font = ("Lucida Console", 20, "italic"))
greeting.grid(padx = 18)

#---length of password---
lengthlabel = Label(Length, text="Length of Password", width=20, height=5, font = ("Arial", 10, "bold"))
lengthlabel.grid(row = 5, column = 1, padx = 3, pady = 10)

len = IntVar()
scale = Scale(Length, orient = HORIZONTAL, from_ = 6, to = 24, tickinterval = 1, length = 500, variable=len)
scale.grid(row = 5, column = 2)


#---strength of password---
strengthlabel = Label(strength, text = "Strength",justify="center", width = 6, height = 2, font = ("Arial", 12, "bold"))
strengthlabel.grid(row = 10, column = 2, pady = 10)

opt = IntVar()
c1 = Radiobutton(strength, text="Low", width = 6, height = 2 , variable=opt, value = 1, font = ("Arial", 12))
c1.grid(row = 12, column = 2, ipadx = 2, ipady = 2, sticky = 'E', pady = 5, padx = 5)

c2 = Radiobutton(strength, text="Medium", width = 6, height = 2, variable=opt, value = 2, font = ("Arial", 12))
c2.grid(row = 14, column = 2, ipadx = 2, ipady = 2,  sticky = 'E', pady = 5, padx = 5)

c3 = Radiobutton(strength, text="High", width = 6, height = 2, variable=opt, value = 3, font = ("Arial", 12))
c3.grid(row = 16, column = 2, ipadx = 2, ipady = 2,  sticky = 'E', pady = 5, padx = 5)


#---output---
genbtn = Button(output, text = "Generate Password", justify = "center", width = 20, height = 3, command=gen, font = ("Arial", 12, "bold"))
...
copybtn = Button(output, text = "Copy", justify = "center", width = 20, height = 3, font = ("Arial", 12, "bold"), command=cpy)
